...
<body>
<a href="../../index.jsp" target="_blank">Main menu</a>
<br/>
<br/>
        ...
        <table class="tg">
            ...
            <c:forEach items="${users}" var="user">
                <tr>
                    ...
                    <td>
                        <center><a href="<c:url value='/edit/${user.id}'/>"target="_blank">Edit</a></center>
                    </td>
                    <td>
                        <center><a href="<c:url value='/remove/${user.id}'/>"target="_blank">Delete</a></center>
                    </td>
                </tr>
            </c:forEach>
        </table>
